...
export default function Home() {
  return (
    <div className="w-full min-h-screen flex flex-col items-center px-4 pt-24 md:pt-32 pb-16 overflow-x-hidden">
      ...
      <motion.div
        className="relative w-full max-w-5xl h-[850px] mt-12 md:mt-16 mx-auto"
        variants={containerVariants}
        initial="hidden"
        animate="visible"
      >
        <motion.div
          className="absolute top-10 left-[10%] sm:left-[15%] lg:left-[18%] w-48 h-64 bg-white/10 backdrop-blur-xl rounded-3xl border border-white/30 overflow-hidden shadow-lg"
        ...
        <motion.div
          className="absolute top-1/2 -translate-y-1/2 left-[5%] sm:left-[10%] lg:left-[12%] w-[340px] bg-white/40 backdrop-blur-2xl rounded-3xl p-6 border border-white/50 shadow-2xl space-y-6 z-20"
          variants={itemVariants}
        ...
        <motion.div
          className="absolute top-1/2 -translate-y-[55%] left-1/2 -translate-x-1/2 w-[320px] h-[240px] sm:w-[480px] sm:h-[360px] lg:w-[500px] lg:h-[375px] bg-gray-900/80 backdrop-blur-sm rounded-3xl border border-white/10 overflow-hidden shadow-2xl z-10"
          variants={itemVariants}
        ...
        <motion.div
          className="absolute top-24 right-[8%] sm:right-[12%] lg:right-[16%] w-[320px] h-[280px] sm:w-[380px] sm:h-[320px] bg-white/20 backdrop-blur-lg rounded-3xl border border-white/30 overflow-hidden shadow-xl"
          variants={itemVariants}
          whileHover={{ scale: 1.05, y: -5, zIndex: 22 }}
          transition={{ type: 'spring', stiffness: 300 }}
        >
        ...
        <motion.div
          className="absolute bottom-24 right-[12%] sm:right-[18%] lg:right-[22%] w-36 h-36 bg-white/60 backdrop-blur-xl rounded-[32px] border border-white/70 shadow-2xl flex flex-col items-center justify-center space-y-4"
          variants={itemVariants}
          whileHover={{ scale: 1.05, y: -5, zIndex: 22 }}
          transition={{ type: 'spring', stiffness: 300 }}
        >
